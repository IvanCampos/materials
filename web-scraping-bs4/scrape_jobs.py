...
def scrape_jobs(location=None):
    ...
    if location:
        ...
        URL = f"https://www.monster.com/jobs/search/?q=Solution+Architect&where=Boston__2C-MA&stpage=1&page=10"
...
def print_all_jobs(results):
    ...
    with open(file_name, 'w') as csvfile:
        ...
        csvwriter.writerow(["TITLE", "LINK", "COMPANY", "LOCATION"])
        ...
        for job_elem in job_elems:
            ...
            csvwriter.writerow([title_elem.text.strip(), link_elem["href"], company_elem.text.strip(), location_elem.text.strip()])
